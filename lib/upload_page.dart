...
class _Uploader extends State<Uploader> {
  ...
  initState() {
    ...
    currentUser();
    mmmUser = widget.usModel;
    uploadUser = widget.usModel;
...
class PostForm extends StatelessWidget {
  ...
  CollectionReference collectionReference = Firestore.instance.collection("insta_users");
...
Future<String> uploadImage(var imageFile) async {
  ...
  StorageReference ref = FirebaseStorage.instance.ref().child(uploadUser.id).child('feed_posts').child(dat);
...
void postToFireStore(
    {String mediaUrl, String location, String description, String currentUId, User poUser}) async {

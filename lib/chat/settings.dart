...
class SettingsScreen extends StatefulWidget {
  ...
  @override
  State createState() => new SettingsScreenState(this.id);
}
...
//  }
  ...
  Future uploadFile() async {
    ...
    StorageReference reference = FirebaseStorage.instance.ref().child(id).child('profile_pictures').child(dat);

...
class ActivityFeedPage extends StatefulWidget {
  ...
  ActivityFeedPage(this.myUser);

  @override
  _ActivityFeedPageState createState() => _ActivityFeedPageState(myUser);
}
...
class _ActivityFeedPageState extends State<ActivityFeedPage> with AutomaticKeepAliveClientMixin<ActivityFeedPage> {
  ...
  _ActivityFeedPageState(this.meroUser);

  @override
  Widget build(BuildContext context) {
    print("this is my user: ${meroUser.username}");

...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.peerId, @required this.nickname, @required this.peerAvatar}) : super(key: key);
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key key, @required this.peerId, @required this.nickna, @required this.peerAvatar}) : super(key: key);

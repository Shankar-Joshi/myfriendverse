...
//          FadeInImage.memoryNetwork(placeholder: kTransparentImage, image: mediaUrl),
  ...
  void _likePost(String postId2) {
    ...
    if (!_liked) {
      print('liking');
      reference.document(postId).updateData({'likes.$currentUserId': true});
  ...
  void addActivityFeedItem() {
    print("like username is below: ${currentuserprofile.username}");
    Firestore.instance
      ...
      "type": "like",
      "userProfileImg": currentuserprofile.photoUrl,
      "mediaUrl": mediaUrl,

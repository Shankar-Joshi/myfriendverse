...
class _Feed extends State<Feed> with AutomaticKeepAliveClientMixin<Feed> {
  ...
  _getFeed() async {
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var url =
        'https://us-central1-reactproject-9c1b4.cloudfunctions.net/getFeed?uid=' + id;
    ...
    try {
      ...
      if (response.statusCode == HttpStatus.ok) {
        ...
        result =
            'Error getting a feed: Http status ${response.statusCode} | userId $id';
      }
    } catch (exception) {
